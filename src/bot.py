...
def fetch_url_from_date(date_selection, langSelected):
    try:
        ...
        # Map the language codes to the ones used by JW
        lang_codes = {
            'es': 'S',          # Español
            'en': 'E',          # English
            'fr': 'F',          # Français
...
def get_default_questions(trans):
    ...
    init_question_3 = trans("Una explicación sobre uno de los textos que aparezcan, que aplique al párrafo. Usa la Biblia de Estudio")
